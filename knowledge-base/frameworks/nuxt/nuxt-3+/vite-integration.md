...
Nuxt 3+ 默认使用 Vite 作为构建工具，提供了更快的开发体验和更好的构建性能。Vite 的集成为 Nuxt 3+ 应用带来了新的安全特性和挑战。了解和配置 Vite 的安全特性对于构建安全的 Nuxt 3+ 应用至关重要。
...
1. **使用官方插件**：优先使用 Vite 和 Nuxt 的官方插件
...
- [Nuxt 官方文档 - Vite 集成](https://nuxt.com/docs/getting-started/vite)
