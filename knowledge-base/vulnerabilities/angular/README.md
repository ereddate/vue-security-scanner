...
本目录包含与 Angular 相关的安全漏洞信息，按版本和类型分类。
...
│   ├── angular-router/ # Angular Router 漏洞
│   ├── angular-material/ # Angular Material 漏洞
│   ├── nx/             # Nx 漏洞
│   └── other/          # 其他生态系统漏洞
└── CVE-Index.md        # CVE 索引
```
...
- **影响版本**：[版本范围]（如 Angular 10.0.0 - 10.2.5）
- **严重性**：[严重/高/中/低]
- **CVSS 评分**：[评分]
- **发布日期**：[YYYY-MM-DD]
- **更新日期**：[YYYY-MM-DD]
